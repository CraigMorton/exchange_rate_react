...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BitcoinAppContainer = __webpack_require__(159);
	
	var _BitcoinAppContainer2 = _interopRequireDefault(_BitcoinAppContainer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	window.onload = function () {
	  _reactDom2.default.render(_react2.default.createElement(_BitcoinAppContainer2.default, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var calcPriceChange = function calcPriceChange(oldPrice, newPrice) {
	  if (oldPrice == null) oldPrice = newPrice;
	
	  var same = function same() {
	    return oldPrice === newPrice;
	  };
	  var greater = function greater() {
	    return oldPrice < newPrice;
	  };
	  ...
	  var lookup = {
	    same: same, greater: greater, lower: lower
	  };
	  var keys = Object.keys(lookup);
	  for (var i = 0; i < keys.length; i++) {
	    var foundTrue = lookup[keys[i]]();
	    if (foundTrue) {
	      console.log(keys[i]);
	      return keys[i];
	    }
	...
	var BitcoinAppContainer = _react2.default.createClass({
	  displayName: 'BitcoinAppContainer',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'h1',
	        { className: 'price-' + this.state.priceChange },
	  ...
	  getData: function getData() {
	    ...
	    request.onload = function () {
	      if (request.status >= 200 && request.status < 400) {
	        var btcInfo = JSON.parse(request.responseText);
	        var gbpPrice = btcInfo.bpi.GBP.rate_float;
	        console.log("Price at", new Date(Date.now()), ":", gbpPrice);
	        var priceChange = calcPriceChange(_this.state.price, gbpPrice);
	        _this.setState({ price: gbpPrice, priceChange: priceChange });
	      }
	    };
	    request.send();
	  },
	  ...
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
	    var colourChanged = this.state.priceChange != nextState.priceChange;
	    var priceChanged = this.state.price != nextState.price;
	    return colourChanged || priceChanged;
	  },
	  getInitialState: function getInitialState() {
	    return { price: null, priceChange: "same" };
	  }
	
	});
	
	exports.default = BitcoinAppContainer;
